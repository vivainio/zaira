...
- [~] Step 6: Add CI enforcement (Ruff, Windows job). In progress.
  ...
  - [ ] Windows test job not added -- flagging as a separate decision given CI cost/time and that Windows-specific behavior can't be verified from this environment.
